...
export default function Header() {
  return (
    <>
      <header className="  flex  justify-between  sm:px-8  lg:px-12 items-center  py-2  space-x-24 max-w-screen-2xl  mx-auto      container    bg-white     ">
          ...
          <SheetContent>
            ...
            <ul className="  ">
              ...
              <li className=" flex flex-col my-5 mx-3 gap-y-4">
                <Link
                  href="/"
                  className=" hover:text-yellow-500 hover:translate-x-[7px] duration-[2s] drop-shadow-sm"
                >
                  Home
                </Link>
                <Link
                  href="/about"
                  className=" hover:text-yellow-500 hover:translate-x-[7px] duration-[3s] drop-shadow-sm"
                >
                  About
                </Link>
                <Link
        ...
        <nav className="hidden md:block   w-[430px] h-[24px] top-[38px] left-[505px]">
          ...
          <ul className="flex  justify-center gap-2  text-md font-medium tracking-wider  gap-x-4 mx-4">
            <li className=" hover:text-yellow-500 inline-block py-1 px-3 ">
              <Link href="/">Home</Link>
            </li>
     ...
     {/* icons */}
      <div className="flex   items-center gap-3 lg:gap-9 justify-around mx-3">
        {/* account alert */}
        <button  className="" >
          <svg
